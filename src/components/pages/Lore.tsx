...
export default function Lore({ flag }: { flag: boolean }) {
  return (
      ...
      >
        ...
        >
          ...
          <p>
            ...
            , the rare magpie-wheatear, Snoozy knew his week was going to play
            out more strangely than usual.
            <br></br>
            <br></br>
            ...
            <br></br>
            <br></br>
            It is <em>also</em> a story I don't want to tell with one medium.
            Yes yes, you'll get your words, but I want to show you{" "}
            <strong>
            ...
            . You will see this tale from multiple angles, and every follow,
            sale and share will support its creation. If you like the sound of
