...
export default function Art({ flag }: { flag: boolean }) {
    ...
    <CSSTransitionCom show={flag}>
      ...
      >
        ...
        >
          <h1>ARTWORK</h1>
          <p>
            Each piece is hand painted or penned, summoning earmen around
            existing structures all garbled in rawest form.
          </p>
